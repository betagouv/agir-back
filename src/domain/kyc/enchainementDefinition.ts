...
> = {
  ...
  ENCHAINEMENT_KYC_action_simulateur_voiture: [
    { id: KYCID.KYC_possede_voiture_oui_non, is_mandatory: true },
    { id: KYCID.KYC_transport_voiture_duree_detention, is_mandatory: true },
    { id: KYCID.KYC_transport_voiture_annee_fabrication, is_mandatory: true },
    { id: KYCID.KYC_transport_voiture_prix_achat, is_mandatory: true },
    { id: KYCID.KYC_transport_voiture_gabarit, is_mandatory: true },
    { id: KYCID.KYC_transport_voiture_motorisation, is_mandatory: true },
    {
      id: KYCID.KYC_transport_voiture_thermique_carburant,
      is_mandatory: true,
    },
    { id: KYCID.KYC_transport_voiture_km, is_mandatory: true },
    { id: KYCID.KYC_transport_voiture_prix_achat, is_mandatory: true },
  ],
  ENCHAINEMENT_KYC_actions_watt_watchers: [
    ...
    { id: KYCID.KYC_logement_isolation_murs, is_mandatory: false },
