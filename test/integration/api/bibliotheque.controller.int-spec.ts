...
describe('/utilisateurs/id/bibliotheque (API test)', () => {
  ...
  it('GET /utilisateurs/id/bibliotheque_v2 - renvoie tous les articles, sauf ceux hors code commune avec arrondissements partenaire', async () => {
    // GIVEN
    const history: History_v0 = {
      aide_interactions: [],
      quizz_interactions: [],
  ...
  it('GET /utilisateurs/id/bibliotheque_v2 - renvoie tous les articles, sauf ceux hors code departement', async () => {
    // GIVEN
    const history: History_v0 = {
      aide_interactions: [],
      quizz_interactions: [],
