...
describe('/bilan (API test)', () => {
  ...
  it('GET /utilisateurs/id/bilans/last_v3 - get last bilan with proper data', async () => {
    ...
    expect(response.body.bilan_complet).toEqual({
      impact_kg_annee: 8840.271320055625,
      top_3: [
        {
          label: 'Voiture',
          pourcentage: 19,
      ...
      impact_thematique: [
        {
          pourcentage: 24,
          thematique: 'logement',
          impact_kg_annee: 2124.479917430124,
          details: [
            {
              label: 'Construction',
              pourcentage: 11,
              pourcentage_categorie: 44,
              impact_kg_annee: 931.7363636363636,
              emoji: '🧱',
            },
            {
              label: 'Chauffage',
              pourcentage: 9,
              pourcentage_categorie: 39,
              impact_kg_annee: 822.4268363644317,
              emoji: '🔥',
            },
            {
              label: 'Vacances',
              ...
              impact_kg_annee: 153.74592565660123,
              emoji: '🏖',
            },
            {
              label: 'Electricité',
              ...
              impact_kg_annee: 131.94395454545455,
              emoji: '⚡',
            },
            {
              label: 'Climatisation',
        ...
        },
        {
          ...
          impact_kg_annee: 1145.7450700200368,
          details: [
            {
              label: 'Textile',
              pourcentage: 4,
              pourcentage_categorie: 28,
            ...
            },
            {
              ...
              impact_kg_annee: 208.6417424242424,
              emoji: '🛋️',
            },
            {
              label: 'Numérique',
              ...
              impact_kg_annee: 190.9610312121212,
              emoji: '📺',
            },
            {
            ...
            },
            {
              ...
              impact_kg_annee: 96.65113636363635,
              emoji: '🔌',
            },
            {
              label: 'Animaux',
  ...
  it('GET /utilisateurs/id/bilans/last_v3 - get last bilan with proper data #2', async () => {
    ...
    expect(response.body.bilan_complet).toEqual({
      impact_kg_annee: 8805.564091524651,
      top_3: [
        {
          label: 'Voiture',
          pourcentage: 19,
