const utilisateurs = {
  michel0:{
    ...
    interactions: [
      ...
      { id: 'quizz-BC_global_rechauffement_climatique', reco_score: 7, locked: true},
    ],
    suivis: [], //'sa1', 'sa2', 'st1'
  },
  michel6:{
  ...
  benoit: {
    ...
    interactions: [
      ...
      { id: 'quizz-BC_global_gaz_effet_de_serre', reco_score: 1 },
  ...
  dorian: {
    ...
    interactions: [
      ...
      { id: 'suivi_du_jour', reco_score: 1 },
      { id: 'quizz_textile1', reco_score: 1},
      { id: 'quizz_dechets_electroniques', reco_score: 2 },
